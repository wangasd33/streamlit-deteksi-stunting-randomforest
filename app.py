            ...
            if h_data_chart and w_data_chart:
                ...
                with col_zw:
                    ...
                    <div style="background: linear-gradient(135deg, #f8fafc, #f1f5f9); border: 2px solid #cbd5e1; border-radius: 12px; padding: 20px; text-align: center;">
                        ...
                        <p style="margin: 6px 0 10px 0; font-size: 12px; color: #888;">Berat badan menurut usia</p>
                        <div style="border-top: 1px dashed #cbd5e1; padding-top: 10px; margin-top: 8px;">
                            <p style="margin: 0; font-size: 11px; color: #475569; line-height: 1.4; font-style: italic;">
                                ℹ️ Status berat badan dihitung langsung dari standar WHO sebagai informasi pendamping, bukan hasil klasifikasi model Random Forest.
                            </p>
                        </div>
                    </div>
                    """, unsafe_allow_html=True)
